...
const TestRGBot = class {
     ...
     * @returns {Promise<boolean>} true if pathing completes, or false if pathing is cancelled or is otherwise interrupted
     *
     * @example
